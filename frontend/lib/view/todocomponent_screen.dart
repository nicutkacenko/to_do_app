...
class AddToDoComponentScreen extends StatefulWidget {
  final int id;
  const AddToDoComponentScreen({Key? key, required this.id}) : super(key: key);
...
class _AddToDoComponentScreenState extends State<AddToDoComponentScreen> {
  late Future<ToDoComponent> futureToDoComponent;
  ...
  void initState() {
    super.initState();
    getToDoComponent();
    _titleController = TextEditingController(text: 'sss');
    _descriptionController = TextEditingController(text: 'sso');
    _imageUrlController = TextEditingController(text: 'ssi');
  }

  getToDoComponent() async {
    futureToDoComponent =
        ToDoComponentController.getToDoComponent(widget.id.toString());
  }
              ...
              return Column(
                ...
                children: [
                  Container(
                    ...
                    child: Image.network(
                      'https://www.shutterstock.com/image-vector/man-fast-run-icon-rush-600w-1542414617.jpg',
                      fit: BoxFit.fill,
                    ),
                  ),
                  const SizedBox(
